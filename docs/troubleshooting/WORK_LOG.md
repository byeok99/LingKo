...
## 2026-09-07 - 약관 버전 배포 불일치 조사 기록

- 변경 파일: `2026-09-07-consent-deployment-version-mismatch.md`, `README.md`, `WORK_LOG.md`
- 내용: 운영 구버전과 최신 앱의 불일치 증거, API 단독 배포·롤백 및 사용자 요청 미확보 한계를 Issue #111에 연결했다.
- 검증: 약관 관련 테스트 9개·bootJar 성공, 운영 API 재배포 후 공개 문서 버전 2026-09-04와 추천 API 200 확인
- 리스크: 실제 사용자 가입 성공 확인 필요
