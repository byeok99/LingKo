...
| [0003](0003-ios-apple-login.md) | 승인 | iOS Apple identity token과 요청별 nonce 검증 |
...
| [0006](0006-atomic-practice-quota-transitions.md) | 승인 | 조건부 DB UPDATE, 1시간 충전과 최초 생성용 부모 lock으로 평가 기회 정합성 보장 |
