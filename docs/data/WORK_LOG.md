...
## 2026-09-08 - 기본 추천 문장 구성 문서화

- 변경 파일: `data-model.md`, `WORK_LOG.md`
- 내용: V22 적용 후 48개·6개 주제별 8개 구성과 기존 ID·표시 순서 보존, 현재 조회 한도 내 포함을 기록했다.
- 검증: migration 및 앱 limit=50·API 최대 50과 대조
- 리스크: 운영 데이터 반영에는 migration 배포 필요
