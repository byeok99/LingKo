...
- 내용: 파란 색·형태·굵기·카드 그림자·CTA gradient를 계약으로 고정했다. Home pill/energy MAX, Result/Review 어절 선택, Recording Restart, Saved category·북마크 해제를 실제 사용자 흐름으로 검증한다.
- 검증: `flutter analyze`, `flutter test --coverage` 전체 88개 통과, 라인 커버리지 80.56%
